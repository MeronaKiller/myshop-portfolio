...
<body> <!-- product/baesongList.jsp -->
	...
	<div class="reqStr"> ${bdto.reqStr} </div>
      ...
      <div>
       <input id="selBtn" type="button" value="수정" onclick="location='baesongUpdate?id=${bdto.id}'">
       <input id="selBtn2" type="button" value="삭제" onclick="location='baesongDelete?id=${bdto.id}'">
       <input id="selBtn" type="button" value="선택" onclick="jusoJundal(${sts.index})"> 
      </div>
    </div>
  </c:forEach>
  <div id="last"> <input id="btn" type="button" value="배송지추가" onclick="location='baesongWrite'"> </div>
</body>
</html>
