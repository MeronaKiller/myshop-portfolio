			   ...
			   $("#imgAll").animate(
			   {
				   marginLeft:"-1895px"
			   },2000,function()
			          {
				          ...
				          // 그림을 포함하는 id="imgAll"요소의 marginLeft를 0px
...
<body> <!-- main.jsp -->
   <div id="slide">
     <div id="imgAll"> 
      <img src="../static/s1.png" class="img" width="1895" height="373"><img src="../static/s2.png" class="img" width="1895" height="373"> <img src="../static/s3.png" class="img" width="1895" height="373"> <img src="../static/s4.png" class="img" width="1895" height="373"> <img src="../static/s5.png" class="img" width="1895" height="373">  
     </div> 
   </div>
 <section>
      <div class="sang">
